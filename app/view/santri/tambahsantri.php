                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="form-group">
                            <form action="?aksi=tambah-santri" method="post">
                                <table class="table table-striped-columns">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <label for="">Nis Santri</label>
                                                <input type="text" name="nis" id="nisInput" class="form-control"
                                                    placeholder="masukkan nis santri baru" required aria-required="true"
                                                    maxlength="10">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <input type="text" name="nama_santri" id="namaInput"
                                                    class="form-control" placeholder="masukkan nama santri baru"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <textarea name="alamat" id="alamatInput" class="form-control"
                                                    aria-required="true" required maxlength="255"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="form-inline radio">
                                                    <input type="radio" name="jenis_kelamin" id=""
                                                        class="radio radio-inline" value="Laki-Laki" required>
                                                    Laki-Laki
                                                    <input type="radio" name="jenis_kelamin" id=""
                                                        class="radio radio-inline ms-2" value="Perempuan" required>
                                                    Perempuan
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                ?>
                                                    <option value="<?php echo $isi['no_pelanggaran']?>">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                ?>
                                                    <option value="<?php echo $is['no_sanksi']?>">
