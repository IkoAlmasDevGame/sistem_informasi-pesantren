    ...
    <body onload="startTime()">
        <div class="container-fluid pt-1 mt-1">
            <div class="d-grid justify-content-center align-items-center flex-wrap">
                <div class="container-fluid p-1 m-1 mx-auto rounded-1">
                    <div class="card">
                        ...
                        <div class="card-body card-height">
                            <div class="form-group">
                                <form action="?aksi=register-walisantri" method="post">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" name="nama_santri" id="nama_santri"
                                                        class="form-control" placeholder="masukkan nama santri anda ..."
                                                        required aria-required="true" maxlength="128">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="form-inline">
                                                        <input type="radio" name="role" id="radio" class="radio-inline"
                                                            value="wali" aria-controls="radio"> wali santri
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
