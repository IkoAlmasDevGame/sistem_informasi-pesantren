        ...
        <div class="container-fluid">
            <div class="panel panel-defualt">
                <div class="panel-body">
                    <h4 class="panel-heading">Data Master Laporan Diskusi</h4>
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?page=laporan-diskusi" class="text-decoration-none text-primary">
                                Laporan diskusi
                            </a>
                        </li>
                    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <h4 class="card-title">Data Laporan Diskusi</h4>
                    <div class="text-end">
                        <a href="?page=export-diskusi" role="button" class="btn btn-info btn-sm">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $row = $configs->query("SELECT laporan_diskusi.*,
                                     ...
                                     left join keamanan on laporan_diskusi.id_keamanan = keamanan.id_keamanan left join ketua on laporan_diskusi.id_ketua = ketua.id_ketua WHERE nama_santri = '$cari' or laporan_diskusi.no_pelanggaran = '$cari' or laporan_diskusi.no_sanksi = '$cari' or laporan_diskusi.id_keamanan = '$cari' or laporan_diskusi.id_ketua = '$cari' order by laporan_diskusi.nama_santri asc");
                                    }else{
                                    $row = $configs->query("SELECT laporan_diskusi.*, santri.nama_santri,
                                     ...
                                     left join keamanan on laporan_diskusi.id_keamanan = keamanan.id_keamanan left join ketua on laporan_diskusi.id_ketua = ketua.id_ketua order by laporan_diskusi.nama_santri asc");
                                    }
                                    while($isi = $row->fetch_array()){
                                        $_SESSION['id'] = $isi['id_ketua'];
                                ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    ?>
                                    <td>
                                        <a href="?page=laporan-diskusi&aksi=ubahdiskusi&nama_santri=<?=$isi['nama_santri']?>"
                                            class="btn btn-sm btn-info" aria-current="page" role="button">
                                            <i class="fa fa-user-edit fa-1x"></i>
                                        </a>
                                        <a href="?page=print-laporan&nama_santri=<?=$isi['nama_santri']?>"
                                            class="btn btn-sm btn-primary" aria-current="page" role="button">
